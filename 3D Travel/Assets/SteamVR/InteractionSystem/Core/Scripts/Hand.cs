...
namespace Valve.VR.InteractionSystem
{
	...
	public class Hand : MonoBehaviour
	{
		...
		//-------------------------------------------------
		// Was the standard interaction btnTouchpad just pressed? In VR, this is a trigger press. In 2D fallback, this is a mouse left-click.
		//-------------------------------------------------
		...
		//-------------------------------------------------
		// Was the standard interaction btnTouchpad just released? In VR, this is a trigger press. In 2D fallback, this is a mouse left-click.
		//-------------------------------------------------
		...
		//-------------------------------------------------
		// Is the standard interaction btnTouchpad being pressed? In VR, this is a trigger press. In 2D fallback, this is a mouse left-click.
		//-------------------------------------------------
